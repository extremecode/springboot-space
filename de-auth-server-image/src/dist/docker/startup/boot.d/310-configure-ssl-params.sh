...
server.ssl.key-store=$DEPLOYMENT_CONF_DIR/de.keystore
...
server.ssl.trust-store=$DEPLOYMENT_CONF_DIR/de.truststore
server.ssl.trust-store-password=dataelicit@01
server.ssl.enabled=true" >> $DEPLOYMENT_CONF_DIR/application.properties
